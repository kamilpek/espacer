class PlacesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @place.save
        format.html { redirect_to @place, notice: 'Dodano miesjce.' }
  ...
  def update
    respond_to do |format|
      if @place.update(place_params)
        format.html { redirect_to @place, notice: 'Zmodyfikowano miesjce.' }
  ...
  def destroy
    @place.destroy
    respond_to do |format|
      format.html { redirect_to places_url, notice: 'Usunięto miesjce.' }
